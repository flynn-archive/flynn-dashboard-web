...
FlynnDashboard.GithubClient = Marbles.Utils.createClass({
	...
	getPull: function (owner, repo, pullId) {
		return this.performRequest('GET', '/repos/'+ encodeURIComponent(owner) +'/'+ encodeURIComponent(repo) +'/pulls/'+ encodeURIComponent(pullId));
	},
